...
window.TRIPS.mallorca = {
  ...
  days: [
    ...
    { dom: '23', dot: 'var(--color-accent-3)', acts: [
      ...
      { id: 'm2b1b', t: '09:15', cat: 'travel', eur: 2 },
  ...
  i18n: {
    en: {
      ...
      acts: {
        ...
        m2b1b: { title: 'Bus 46, then the climb', desc: 'No bus goes to the castle. EMT has a stop called Castell de Bellver and it has no lines on it — the nearest one that is actually served is pl. Gomila, and the 46 gets there from Plaça d\'Espanya without a change. From the stop it is half a kilometre and eighty metres of climbing up through the pine woods.', tip: 'Checked against EMT\'s own network data: pl. Gomila is served by the 4, the 20 and the 46, and only the 46 also stops at Plaça d\'Espanya. Sundays it runs every 30 minutes — take the one that leaves Sindicat at 09:15 and passes Plaça d\'Espanya a few minutes later. Allow twenty minutes for the walk up; it is 27 m above the sea at the stop and 110 m at the castle, which is a real climb in August. Coming down, the same walk to pl. Gomila and the 47 or the 4 runs back along Joan Miró.' },
    ...
    tr: {
      ...
      acts: {
        ...
        m2b1b: { title: '46 numara, sonra yokuş', desc: 'Kaleye çıkan otobüs yok. EMT\'de "Castell de Bellver" adında bir durak var ama üzerinde hiçbir hat geçmiyor — gerçekten servis verilen en yakın durak pl. Gomila, ve 46 numara oraya Plaça d\'Espanya\'dan aktarmasız gidiyor. Duraktan sonrası çam ormanının içinden yarım kilometre ve seksen metre tırmanış.', tip: 'EMT\'nin kendi ağ verisinden doğrulandı: pl. Gomila\'ya 4, 20 ve 46 uğruyor, bunlardan yalnızca 46 aynı zamanda Plaça d\'Espanya\'da duruyor. Pazar günleri 30 dakikada bir — Sindicat\'tan 09:15\'te kalkıp birkaç dakika sonra Plaça d\'Espanya\'dan geçeni yakala. Yürüyüş için yirmi dakika ayır; durak deniz seviyesinden 27 m, kale 110 m, yani ağustosta ciddi bir tırmanış. Dönüşte aynı yürüyüşle pl. Gomila\'ya inip 47 ya da 4 ile Joan Miró boyunca geri.' },
