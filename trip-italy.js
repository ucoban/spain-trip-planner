...
window.TRIPS.italy = {
  ...
  days: [
    ...
    { dom: '24', dot: 'var(--color-accent)', acts: [
      { id: 'i3b1', t: '08:00', cat: 'travel', eur: 10 },
      { id: 'i3b2', t: '09:15', cat: 'swim', eur: 18 },
      { id: 'i3b3', t: '13:00', cat: 'food', eur: 8 },
      { id: 'i3b4', t: '17:00', cat: 'travel', eur: 0 },
      { id: 'i3b5', t: '21:00', cat: 'food', eur: 22 }
    ] },
    { dom: '25', dot: 'var(--color-accent)', acts: [
      { id: 'i4b1', t: '09:45', cat: 'travel', eur: 5 },
      { id: 'i4b2', t: '11:15', cat: 'sights', eur: 0 },
      { id: 'i4b3', t: '13:15', cat: 'food', eur: 16 },
      { id: 'i4b4', t: '15:15', cat: 'boat', eur: 50 },
      { id: 'i4b5', t: '19:15', cat: 'travel', eur: 5 },
      { id: 'i4b6', t: '21:00', cat: 'food', eur: 22 }
    ] },
  ...
  bookings: ['j1', 'j2', 'j3', 'j4', 'j5', 'j6', 'j14', 'j7', 'j8', 'j9', 'j10', 'j15', 'j11', 'j12', 'j13'],
  ...
  maps: {
    ...
    i3b1: 'Palermo On Bike, Via Discesa dei Giudici 13, Palermo',
    i3b2: 'Mondello beach, Palermo',
    i3b3: 'Lungomare di Mondello, Palermo',
    i3b4: 'Parco della Favorita, Palermo',
    i3b5: 'Pizzeria Procopio, Palermo',
    i4b1: 'Cinisi-Terrasini railway station',
    i4b2: 'Riserva Naturale Capo Rama, Terrasini',
    i4b3: 'Terrasini seafront',
    i4b4: 'Porto di Terrasini',
    i4b5: 'Cinisi-Terrasini railway station',
    i4b6: 'Nino u Ballerino, Palermo',
  ...
  mapCity: ['Palermo', 'Palermo', 'Palermo', 'Terrasini', '', 'Taormina', 'Taormina', 'Catania'],
  ...
  places: {
    ...
    'Parco della Favorita': 'Parco della Favorita, Palermo',
    'Favorita': 'Parco della Favorita, Palermo',
    'Terrasini': 'Terrasini',
    'Capo Rama': 'Riserva Naturale Capo Rama, Terrasini',
    'Torre di Capo Rama': 'Torre di Capo Rama, Terrasini',
    'Cala Rossa': 'Cala Rossa, Terrasini',
    'Cala Muletti': 'Cala Muletti, Terrasini',
    'Grotta delle Colombe': 'Grotta delle Colombe, Terrasini',
    'San Cataldo': 'Spiaggia di San Cataldo, Terrasini',
    'Trappeto': 'Trappeto',
    'Taormina': 'Taormina',
  ...
  map: {
    ...
    spots: [
      ...
      [38.1620, 13.3480, 'sights', 'favorita', 3, '17:00'],
      [38.1245, 13.3565, 'food', 'procopio', 3, '21:00'],
      [38.1660, 13.0790, 'sights', 'caporama', 4, '11:15'],
      [38.1470, 13.0830, 'food', 'terrasini', 4, '13:15'],
      [38.0877, 13.0801, 'sea', 'colombe', 4, '15:15'],
    ...
    views: {
      ...
      'v-pal': { bounds: [[38.070, 13.040], [38.215, 13.400]], pad: 46, label: 'Palermo' },
  ...
  i18n: {
    en: {
      ...
      static: {
        ...
        bcnNote: 'Mosaics, markets, Mondello by bike, Terrasini',
      ...
      days: [
        ...
        { city: 'Mondello', title: 'Mondello, there and back on two wheels', sub: 'Monday 24 Aug · twelve kilometres out on the cycle path before the heat, sand in between, the park on the way home' },
        { city: 'Terrasini', title: 'Terrasini, and the cave from the water', sub: 'Tuesday 25 Aug · west along the coast, a cliff reserve at noon, then a boat into the Grotta delle Colombe' },
      ...
      acts: {
        ...
        i3b1: { title: 'Hire bikes, then the coast road to Mondello', desc: 'Palermo On Bike is five minutes from the hotel on Via Discesa dei Giudici, and Mondello is about twelve kilometres away on a proper cycle path that runs out through the Favorita park. An hour of easy pedalling, flat the whole way, and you arrive at the beach instead of queueing for the 806 in the heat. City bike €10 a day, e-bike €20, lock, lights and repair kit in the price.', tip: 'Leave at eight: the ride is unshaded in places and Palermo traffic is genuinely chaotic on the way out of the centre — take it slowly to the park and it is calm from there. Rental and bookings: https://www.palermonbike.com/en/bici/bike-rental-palermo/ · If a guide sounds better than a map, their Mondello & Favorita tour is four hours, €70 pp. The 806 bus from Piazza Sturzo (€1.40 at a tabacchi, validate on board) is still the fallback if the legs say no.' },
        i3b2: { title: 'Mondello, the sandy one', desc: 'A two-kilometre curve of pale sand between two headlands, shallow and turquoise, with the Liberty-style bathing pavilion standing out on stilts in the middle of the bay. Either take a free strip — they exist at both ends and between the concessions — or rent from a lido.', tip: 'From the vlogs and the local guides: in August the free sand is gone by nine, which is the real reason to be on the road at eight. Two sunbeds and an umbrella run about €35 at the Italo-Belga lidos, which is nearly all of them; book ahead: https://booking.mondelloitalobelga.it/ · The budget version is Bassa Marea at €6–8 a head if you bring your own shade. Ask the lido whether the bikes can come inside the gate — leaving them at a public rack all day is the one weak point of arriving on two wheels.' },
        ...
        i3b4: { title: 'Back through the Favorita park', desc: 'The ride home the long way round: back into the Parco della Favorita, the old royal hunting grounds at the foot of Monte Pellegrino, where the cycle path runs under stone pines and the temperature drops a few degrees. Drop the bikes in town, then a cold shower.', tip: 'The city end of the ride is unshaded and it is still over thirty degrees at five, so fill the bottles at Mondello before setting off — there is nothing to buy in the park. If the legs have had enough, the 806 takes bikes badly and taxis take them not at all: the honest fallback is to leave earlier, not later. Skipped for this: Capo Gallo, the €2 rocky reserve at the far end of the bay with the clearest water near the city — worth it on a day that is not also a ride.' },
        ...
        i4b1: { title: 'Train west to Terrasini', desc: 'Out of Palermo Centrale along the coast the other way, past the airport, to Cinisi-Terrasini — about an hour, roughly five euros, and the town is a twenty-minute walk from the station or a couple of euros on the Cracchiolo bus. This is the Trapani line, so it is the same regional ticket as everywhere else: flat fare, no reservation, nothing to sell out.', tip: 'Timetables disagree about the early departures on this line — the aggregators variously claim the first train at 06:23, 08:49 and 10:12 — so check the Trenitalia app the night before and build the day around the train you can actually catch. Eight or so run a day. https://www.trenitalia.com/en.html' },
        i4b2: { title: 'Capo Rama, the cliff reserve', desc: 'The WWF reserve on the headland north of town: five hectares of dwarf-palm scrub on a white limestone cliff, a sixteenth-century watchtower on the point, and the Cala Porro cave in the rock below. It has been a listed Geosite since 2000, and the whole gulf — Palermo one way, Castellammare the other — opens up from the tower.', tip: 'Whether the gate is staffed and what it costs, if anything, we could not verify from here: WWF reserves in Sicily are usually open access on the path, but treat it as unconfirmed and ask in town. There is no shade on the headland and no water — go before the sun is overhead, hat and a full bottle each.' },
        i4b3: { title: 'Fish lunch in Terrasini', desc: 'Down to the seafront for lunch in a working fishing town rather than a resort: whatever came in that morning, a plate of pasta, and the Palazzo d’Aumale on the front if you want twenty minutes of museum with the coffee.' },
        i4b4: { title: 'By boat into the Grotta delle Colombe', desc: 'The reason for the whole day. A boat leaves the Porto di Terrasini and runs down the coast to the Grotta delle Colombe — the volcanic cove beneath Cala Muletti, the cave you asked about — and stops there for a forty-minute swim inside it. Then on to Cala Rossa, the red-and-white striped rock cove that is the most photographed thing on this coast, and the little calette between them for another forty minutes in the water. Back in port around seven.', tip: '€50 per adult, snorkelling gear €35 more, maximum twenty-odd people aboard, and it runs subject to the sea. Morning (09:15) and afternoon (15:15) departures both exist; the afternoon one is the one that fits a train from Palermo. Book by WhatsApp or phone: +39 338 232 2936 · https://www.dreamingsicily.it/experiences/minicrociera-in-barca-da-terrasini-a-cala-rossa/' },
        i4b5: { title: 'Train back to Palermo', desc: 'Back to the station and east along the coast, into Palermo for the evening.', tip: 'The land route to Cala Muletti, for the record, since it is what the photographs are of: from the parking above San Cataldo beach it is five minutes down, then a path right that hugs the mountain, past an abandoned building and one exposed section, to a wartime bunker — and from the bunker the famous staircase drops to the sea. Fifteen minutes in all, and one walking blog calls it simple. But there are no railings, the stairs are steep, and after the place went viral an Italian magazine listed it among the most dangerous spots in the country. It also needs a car or a taxi from the station, which this trip does not have. The boat swims in the same cave.' },
        i4b6: { title: 'Back in Palermo: pane e panelle, or the brave option', desc: 'A last Palermo evening. The brave version is Nino u Ballerino out on Corso Calatafimi for pane ca meusa — a bun of spleen and lung, boiled then fried in lard, with lemon and grated caciocavallo. The gentle version is another plate of panelle, and nobody is judging.' },
      ...
      bookings: {
        ...
        j14: 'Terrasini boat to the Grotta delle Colombe + Cala Rossa, Tue 25 · 15:15 from Porto di Terrasini — €50 pp, snorkelling gear €35 more, about twenty-odd seats and weather-dependent, so book and reconfirm the morning of. WhatsApp +39 338 232 2936 · https://www.dreamingsicily.it/experiences/minicrociera-in-barca-da-terrasini-a-cala-rossa/',
        j15: 'Bikes for the Mondello ride, Mon 24 — city bike €10 a day, e-bike €20, from Palermo On Bike five minutes from the hotel; no need to book far ahead but a message the day before secures two. https://www.palermonbike.com/en/bici/bike-rental-palermo/',
      ...
      map: {
        ...
        spots: {
          ...
          favorita: 'Favorita park, the ride home',
          procopio: 'Pizza at Procopio',
          caporama: 'Capo Rama cliff reserve',
          terrasini: 'Lunch in Terrasini',
          colombe: 'Grotta delle Colombe + Cala Rossa',
      ...
      stays: {
        ...
        palSub: 'Sat 22 → Wed 26 Aug. The base has to work for an early Palatine Chapel, market lunches, the 806 to Mondello from the Politeama, the Terrasini trains out of Centrale, and a late arrival on the airport coach.',
    ...
    tr: {
      ...
      static: {
        ...
        bcnNote: 'Mozaikler, pazarlar, bisikletle Mondello, Terrasini',
      ...
      days: [
        ...
        { city: 'Mondello', title: 'Mondello, gidiş dönüş iki tekerlekle', sub: '24 Ağustos Pazartesi · sıcak basmadan on iki kilometre bisiklet yolu, arada kum, dönüşte park' },
        { city: 'Terrasini', title: 'Terrasini ve mağara, denizden', sub: '25 Ağustos Salı · kıyı boyunca batıya, öğlen uçurum rezervi, sonra tekneyle Grotta delle Colombe’ye' },
      ...
      acts: {
        ...
        i3b1: { title: 'Bisiklet kirala, sonra kıyı yolundan Mondello’ya', desc: 'Palermo On Bike otelden beş dakika, Via Discesa dei Giudici’de; Mondello ise Favorita parkının içinden geçen düzgün bir bisiklet yoluyla yaklaşık on iki kilometre. Bir saatlik rahat pedal, baştan sona düz ve sıcakta 806 kuyruğunda beklemek yerine doğrudan plaja varıyorsun. Şehir bisikleti günlük €10, e-bike €20; kilit, ışık ve tamir seti fiyatın içinde.', tip: 'Sekizde çık: yolun bir kısmı gölgesiz ve merkezden çıkarken Palermo trafiği gerçekten karışık — parka kadar yavaş git, orandan sonrası sakin. Kiralama ve rezervasyon: https://www.palermonbike.com/en/bici/bike-rental-palermo/ · Haritadansa rehber iyi gelirse Mondello & Favorita turu dört saat, kişi başı €70. Bacaklar itiraz ederse Piazza Sturzo’dan 806 otobüsü (tabacchi’den €1,40, binince valide et) hâlâ yedekte.' },
        i3b2: { title: 'Mondello, kumlu olan', desc: 'İki burun arasında iki kilometrelik açık renk kum kavisi; sığ, turkuaz ve koyun ortasında kazıklar üstünde duran Liberty üslubu plaj pavyonu. Ya ücretsiz şeritlerden birine kur (iki uçta ve işletmelerin arasında var) ya da bir lidodan kirala.', tip: 'Vloglar ve yerel rehberler hemfikir: ağustosta ücretsiz kum dokuzda bitiyor — sekizde yola çıkmanın asıl sebebi bu. İki şezlong ve şemsiye Italo-Belga lidolarında (yani neredeyse hepsinde) €35 civarı; önceden ayırt: https://booking.mondelloitalobelga.it/ · Ekonomik versiyon: kendi gölgeni götürürsen Bassa Marea kişi başı €6-8. Lidoya bisikletleri içeri alıp almadıklarını sor — onları bütün gün dışarıdaki bir askıda bırakmak, iki tekerlekle gelmenin tek zayıf noktası.' },
        ...
        i3b4: { title: 'Dönüş, Favorita parkının içinden', desc: 'Eve uzun yoldan dönüş: Monte Pellegrino’nun dibindeki eski kraliyet avlağı Parco della Favorita’ya geri gir; bisiklet yolu fıstık çamlarının altından geçiyor ve sıcaklık iki üç derece düşüyor. Bisikletleri şehirde teslim et, sonra soğuk duş.', tip: 'Yolun şehir kısmı gölgesiz ve beşte hâlâ otuz derecenin üstü, o yüzden mataraları çıkmadan Mondello’da doldur — parkta bir şey satan yok. Bacaklar bitmişse: 806’ya bisiklet zor biniyor, taksiye hiç binmiyor; dürüst yedek plan geç değil erken çıkmak. Bunun için feda edilen: Capo Gallo, koyun ucundaki €2’lik kayalık rezerv, şehir çevresinin en berrak suyu — bisikletli olmayan bir güne değer.' },
        ...
        i4b1: { title: 'Batıya, Terrasini treni', desc: 'Palermo Centrale’den kıyı boyunca ters yöne, havalimanını geçip Cinisi-Terrasini’ye — yaklaşık bir saat, beş euro civarı; kasaba istasyondan yirmi dakika yürüme ya da iki euroluk Cracchiolo otobüsü. Bu Trapani hattı, yani bilet her yerdeki gibi: sabit fiyat, rezervasyon yok, dolması diye bir şey yok.', tip: 'Bu hattın ilk seferleri konusunda tarifeler birbirini tutmuyor — siteler sırasıyla 06:23, 08:49 ve 10:12 diyor — o yüzden bir akşam önce Trenitalia uygulamasından bak ve günü gerçekten yetişebileceğin trene göre kur. Günde sekiz civarı sefer var. https://www.trenitalia.com/en.html' },
        i4b2: { title: 'Capo Rama, uçurum rezervi', desc: 'Kasabanın kuzeyindeki burunda WWF rezervi: beyaz kireçtaşı uçurumun üstünde beş hektar bodur palmiye çalılığı, burnun ucunda on altıncı yüzyıldan bir gözetleme kulesi, altındaki kayada Cala Porro mağarası. 2000’den beri tescilli jeosit ve kuleden bütün körfez açılıyor — bir yanda Palermo, öbür yanda Castellammare.', tip: 'Girişin görevlisi var mı, ücretli mi — buradan doğrulayamadık: Sicilya’daki WWF rezervlerinde patika genelde serbest ama bunu teyit edilmemiş kabul et, kasabada sor. Burunda gölge de su da yok — güneş tepeye çıkmadan git, şapka ve dolu birer matara.' },
        i4b3: { title: 'Terrasini’de balık öğle yemeği', desc: 'Tatil köyü değil, çalışan bir balıkçı kasabasında öğle yemeği için sahile in: o sabah ne geldiyse, bir tabak makarna ve kahvenin yanına yirmi dakikalık müze istersen sahildeki Palazzo d’Aumale.' },
        i4b4: { title: 'Tekneyle Grotta delle Colombe’ye', desc: 'Bütün günün sebebi. Tekne Porto di Terrasini’den kalkıp kıyı boyunca Grotta delle Colombe’ye iniyor — Cala Muletti’nin altındaki volkanik koy, yani sorduğun mağara — ve içinde kırk dakikalık yüzme molası veriyor. Sonra bu kıyının en çok fotoğraflanan yeri Cala Rossa’nın kırmızı-beyaz damarlı kayaları ve aradaki küçük koylarda kırk dakika daha suda. Yediye doğru limana dönüş.', tip: 'Yetişkin €50, şnorkel takımı €35 ilave, teknede en fazla yirmi küsur kişi ve deniz uygun olursa kalkıyor. Sabah (09:15) ve öğleden sonra (15:15) iki sefer var; Palermo’dan trenle yetişilebilen öğleden sonraki. WhatsApp ya da telefonla ayırt: +39 338 232 2936 · https://www.dreamingsicily.it/experiences/minicrociera-in-barca-da-terrasini-a-cala-rossa/' },
        i4b5: { title: 'Palermo’ya dönüş treni', desc: 'İstasyona dön ve kıyı boyunca doğuya, akşam için Palermo’ya.', tip: 'Cala Muletti’ye karadan gidiş — fotoğrafların çekildiği yol bu, kayda geçsin: San Cataldo plajının üstündeki park yerinden beş dakika aşağı, sonra sağa, dağa yapışan patika; terk edilmiş bir yapı ve bir açık kesitten sonra savaştan kalma sığınak, sığınaktan da o meşhur merdiven denize iniyor. Toplam on beş dakika ve bir yürüyüş blogu “basit” diyor. Ama korkuluk yok, merdiven dik ve yer sosyal medyada patladıktan sonra bir İtalyan dergisi burayı ülkenin en tehlikeli yerleri arasında saydı. Üstelik araba ya da istasyondan taksi istiyor; bu gezide ikisi de yok. Tekne aynı mağarada yüzdürüyor.' },
        i4b6: { title: 'Palermo’da son akşam: pane e panelle, ya da cesur seçenek', desc: 'Palermo’daki son akşam. Cesur versiyon Corso Calatafimi’deki Nino u Ballerino’da pane ca meusa — haşlanıp iç yağında kızartılmış dalak ve akciğerin, limon ve rendelenmiş caciocavallo ile ekmek arasına girmiş hali. Nazik versiyon bir tabak daha panelle; kimse yargılamıyor.' },
      ...
      bookings: {
        ...
        j14: 'Terrasini’den Grotta delle Colombe + Cala Rossa teknesi, 25 Sal · 15:15, Porto di Terrasini — kişi başı €50, şnorkel takımı €35 ilave; yirmi küsur koltuk ve denize bağlı, o yüzden ayırt ve sabahı teyit et. WhatsApp +39 338 232 2936 · https://www.dreamingsicily.it/experiences/minicrociera-in-barca-da-terrasini-a-cala-rossa/',
        j15: 'Mondello turu için bisikletler, 24 Pzt — şehir bisikleti günlük €10, e-bike €20; Palermo On Bike otelden beş dakika. Çok önceden ayırtmak gerekmiyor ama bir gün önce mesaj atmak iki bisikleti garantiler. https://www.palermonbike.com/en/bici/bike-rental-palermo/',
      ...
      map: {
        ...
        spots: {
          ...
          favorita: 'Favorita parkı, dönüş yolu',
          procopio: 'Procopio’da pizza',
          caporama: 'Capo Rama uçurum rezervi',
          terrasini: 'Terrasini’de öğle yemeği',
          colombe: 'Grotta delle Colombe + Cala Rossa',
      ...
      stays: {
        ...
        palSub: '22 Cmt → 26 Çar. Üssün işi: erken Palatina, pazar yemekleri, Mondello’ya bisiklet yolu, Centrale’den Terrasini trenleri ve havalimanı otobüsüyle gece varış.',
